...
2. **Télécharger le dataset corpus_pubtator.txt.gz et le placer à la racine du projet**

3. **Créer un environnment virtuel** :
   ```bash
   python3 -m venv env
   source env/bin/activate  # Sur Windows: env\Scripts\activate

4. **Installer les dépendances à l'aide du fichier requirements.txt** :
   ```bash
